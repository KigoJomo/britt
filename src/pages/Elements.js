...
const IconButton = ({width}) => {
  return (
    <>
      <button className="btn-ic bg-black text-white flex items-center justify-center rounded-full w-8 md:w-16 md:text-3xl aspect-1" style={{width: width}}><Link to="/projects">&#x2197;</Link></button>
    </>
  );
};
